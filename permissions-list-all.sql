...
/*  
    DISCLAIMER: THIS QUERY WAS NOT MADE BY MARCELO VITAL. IT WAS FOUND ON THE INTERNET 
    (https://stackoverflow.com/questions/7048839/sql-server-query-to-find-all-permissions-access-for-all-users-in-a-database)
    ORIGINALLY POSTED BY USER Jeremy (https://stackoverflow.com/users/9266/jeremy) AT AUG 14 2011
*/
